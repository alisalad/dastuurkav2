  ...
  <Layout>
    <div class="pt-8 md:pt-16">
      <div class="flex flex-col items-center">
        ...
        <h1 class="text-2xl text-center lg:text-5xl">
          Jamhuuriyadda Federaalka ee Soomaaliya.
        </h1>
        <p class="text-xl font-small text-center">
          <strong class="text-ui-primary">Fiiro Gaar ah</strong>
          <br>
        ...
        <p class="mt-8 text-center">
          Copyright © 2019 | Dastuurka | Developed Ali Salad | <span class="border-b border-dashed border-ui-primary text-ui-primary">@alibashi5</span>
        </p>
